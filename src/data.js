...
var D = {
  ...
  commandes: [
    ...
    { id:250, etat:"attente", mode:"livraison", heure:"19:43", client:"Karim", expire:64,
      ...
      adresseDetail:{numero:"8",rue:"rue Jaboulay",codePostal:"69007",ville:"Lyon",complement:"Bâtiment B · 3e étage",acces:"Digicode 47A29"},
    ...
    { id:247, etat:"preparation", mode:"livraison", heure:"19:38", prete:"20:05", client:"Mehdi",
      ...
      adresseDetail:{numero:"24",rue:"avenue Berthelot",codePostal:"69007",ville:"Lyon",complement:"1er étage",acces:""},
    ...
    { id:245, origine:"restaurant", referenceCaisse:"DEMO-CAISSE-245", etat:"prete", mode:"retrait", heure:"19:30", prete:"19:45", client:"Yanis",
  ...
  /* Relations explicitement configurées pour les ruptures de démonstration.
     Ne jamais déduire les allergènes ou une recette depuis un nom de produit. */
  cuisineOperations: {
    heureReference:"19:44",
    ingredients:[
      {id:"mozzarella",nom:"Mozzarella",produits:["4from","merguez"]},
      {id:"pain-burger",nom:"Pain burger",produits:["burger"]}
    ],
    problemes:["Produit indisponible","Précision à demander","Client injoignable","Autre problème"]
  },

  /* Événement fictif rejouable : aucun logiciel de caisse réel connecté. */
  caisseDemo: {
    id:901, origine:"restaurant", referenceCaisse:"DEMO-CAISSE-901", versionCaisse:1,
    etat:"confirmee", mode:"retrait", heure:"20:10", date:"2026-09-23", client:"Lina",
    lignes:[{q:1,nom:"Tacos M",opt:"Poulet · sauce algérienne · frites + Oasis",sup:"Cheddar",dem:"",prix:1050}],
    total:1050, paiement:"Sur place", encaissement:"non_transmis", imprime:true
  },
  ...
  /* Projet de mentions légales de la future version officielle.
     Ne pas présenter comme publiable avant immatriculation et choix de l'hébergeur. */
  mentionsLegales: {
    editeur:"Arturo SAS",
    forme:"société par actions simplifiée",
    capital:"4 000 €",
    adresse:"12 rue du Moulin, 28230 Droue-sur-Drouette, France",
    nomCommercial:"Pelyo",
    email:"pelyo.arturo@gmail.com",
    telephone:"07 69 77 96 76",
    directeur:"Grégory Artot",
    fonctionDirecteur:"président d’Arturo SAS"
  },
  ...
  regles: {
    ...
    rgpd:"Message validé : « Bonjour, je suis l'assistant IA du restaurant [Nom]. Cet appel est enregistré pour traiter votre commande et améliorer notre service. Vous pouvez dire “je refuse l'enregistrement” à tout moment. Que souhaitez-vous commander ? » En cas de refus : « Très bien, aucun enregistrement audio ne sera conservé. Je peux continuer à prendre votre commande. » Un refus à tout moment supprime l'intégralité de l'audio de l'appel. Sinon, l'audio est supprimé après 7 jours, ou 30 jours maximum si un incident est signalé. La transcription et la copie Pelyo de la commande sont supprimées après 6 mois. L'utilisation des transcriptions pour améliorer l'IA nécessite un cadre distinct avant activation."
  }
};
